...
features:
  - icon: 🔍
    ...
    details: Query the Epstein files by name — full or partial matches across all released documents.
  - icon: 📄
    title: Browse Documents
    details: List and retrieve documents by ID or category — flight logs, depositions, and more.
  - icon: 🧩
    title: MCP Native
